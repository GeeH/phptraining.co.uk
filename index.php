                    ...
                    <div class="ui grid">
                        <div class="computer tablet only row">
                            <div class="ui huge secondary basic menu">
                                ...
                                <a data-scroll href="#courses" class="item">Courses</a>
                                <a data-scroll href="#cta" class="item">Enroll</a>
                            </div>
                        </div>
...
class ListController extends AbstractActionController
{
    ...
    public function __construct(PostRepositoryInterface $postRepository)
    {
        ...
        <section id="bespoke" class="ui inverted vertical segment bespoke">
            <div class="ui text container intro-text pt pb">
        ...
        <footer class="ui inverted vertical footer segment pt pb">
            <div class="ui container">
                <div class="ui stackable inverted divided equal height stackable grid">
                    <div class="three wide column">
                        <h2 class="ui inverted header">PHP Training</h2>
                        <h4 class="ui inverted header">Get trained by professionals</h4>
                    </div>
                    <div class="three wide column">
                        <h4 class="ui inverted header">Quick Nav</h4>
                    ...
                    <div class="three wide column">
                        ...
                        <div class="ui inverted link list">
                            <a href="#courses" class="item">Building APIs</a>
                            <a href="#courses" class="item">Introducing Zend Framework</a>
                            <a href="#courses" class="item">Using Laravel for Rapid Development</a>
                        </div>
                    </div>
                    <div class="seven wide column">
                        <h4 class="ui inverted header">Here is how to get in touch with us</h4>
                        <p>You can drop us an email at <a href="mailto:info@phptraining.co.uk">info@phptraining.co.uk</a> </p>
                    </div>
                </div>
            </div>
            </div>
